...
<html>
<head>
    <title>CliffHanger - Ajouter une voie</title>
...
<div class="container">
    <s:form class="form-horizontal" role="form" method="POST" action="addVoie">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" name="voie.nom" class="form-control" id="name"
                               data-minlength="2" data-error="Le nom du secteur doit faire deux caractères au minimum"
                               placeholder="Nom de la voie" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label class="col-xs-3 control-label" for="voieSecteurNom">Secteur  correspondant : </label>
            </div>
            ...
            <div class="form-group checkbox-warning-filled">
                <input type="checkbox" id="checkbox110" name="voie.etat" class="filled-in" checked>
                <label for="checkbox110">Equipé ?</label>
            </div>
