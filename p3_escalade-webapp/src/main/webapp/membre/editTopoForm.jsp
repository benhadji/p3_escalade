...
<s:form action="editTopoForm" namespace="/membre">
    <div class="row">
        ...
        <div class="text-center col-md-6">
            <h2>Modifier topo : <s:property value="topo.nom"/></h2>
            <hr>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3 field-label-responsive">
            <label for="name">Nouveau nom du Topo : </label>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <input type="text" name="topo.nom" class="form-control" id="name"
                           data-minlength="2" data-error="Le nom du topo doit faire deux caractères au minimum"
                           placeholder="Nom du topo" required autofocus>
                </div>
            </div>
        </div>
        <div class="col-md-3">
