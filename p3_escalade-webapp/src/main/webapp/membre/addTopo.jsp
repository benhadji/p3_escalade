...
<div class="container">
    <s:form class="form-horizontal" role="form" method="POST" action="addTopo">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" name="topo.nom" class="form-control" id="name"
                               data-minlength="2" data-error="Le nom du secteur doit faire deux caractères au minimum"
                               placeholder="Nom topo" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label class="col-xs-3 control-label" for="topoSiteNom">Site  correspondant : </label>
            </div>
            ...
            <div class="form-group checkbox-warning-filled">
                <s:checkbox id="topoBorrowed" name="topo.emprunt" value="false" class="filled-in"/>
                <label for="topoBorrowed">Autorisé le pret de ce topo ?</label>
            </div>
